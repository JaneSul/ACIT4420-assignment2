...
class StudentsManager:
    ...
    def load_students(self):
        ...
        try:
            ...
            return [
                {"name": "Alice", "email": "alice@example.com", "course": "Computerence","preferred_time": "21:37"},
                {"name": "Bob", "email": "bob@example.com", "course": "Mathematics","preferred_time": "21:38"},
                {"name": "Charlie", "email": "charlie@example.com", "course": "Physics","preferred_time": "21:39"}
            ]
